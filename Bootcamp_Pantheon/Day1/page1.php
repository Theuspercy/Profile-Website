    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-7 Myinfos">
          ...
          <p>I like to listen to old song</p>
          <p>My favorite foods are Pares, Kadiyos, Bulalo and Adobo</p>
          <p>My dream is to explore the space and yes to be an Astronaut</p>
          <p>I like playing games specially Call of Duty Mobile</p>
        </div>
      </div>
    </div>
  </body>
